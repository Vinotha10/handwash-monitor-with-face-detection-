...
from face_recognition.utils.helpers import distance2bbox, distance2kps
...
class SCRFD:
    ...
    def __init__(
        ...
        print("Model path resolved to:", self.model_path)
...
if __name__ == "__main__":
    detector = SCRFD(model_path="det_10g.onnx")  # Only filename needed now
